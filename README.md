...
| --- | --- | --- |
| 林明 | 23375181 | A：平台与集成 |
| 刘钟屹 | 23375291 | B：身份与社区 |
| 李晓萌 | 24371422 | C：内容与媒体 |
| 张壮志 | 24371350 | D：直播与礼物 |
| 王一涵 | 24371063 | E：治理、质量与文档 |

用户于 2026-08-31 提供成员表并授权按行顺序默认对齐 A–E；来源边界见 [`delivery/05_management/member-role-mapping.md`](delivery/05_management/member-role-mapping.md)。该映射用于项目文档和任务编排，不等于五人已签署贡献权重或确认实际参会记录。
