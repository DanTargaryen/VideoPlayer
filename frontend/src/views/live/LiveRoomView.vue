  ...
  <section class="live-page">
        ...
        <div class="studio-main">
          ...
          <form class="live-settings" @submit.prevent="handleStartLive">
            ...
            <div class="setting-actions">
              <el-button :loading="preparing" @click="handlePreparePreview">{{ previewActionText }}</el-button>
    ...
    <el-dialog v-model="studioVisible" title="创建直播" width="620px">
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="preparing" :disabled="!isLoggedIn" @click="handlePreparePreview">{{ previewActionText }}</el-button>
      </template>
    </el-dialog>
...
import { createReplayUploadFile, getReplayContainerMimeType } from '@/utils/replayMedia';
import {
  ArrowRight,
  CircleCheck,
  DataLine,
...
const previewActionText = computed(() => {
  if (!hasPreview.value) return '准备预览';
  return isLive.value ? '重新准备预览' : '取消预览';
});
