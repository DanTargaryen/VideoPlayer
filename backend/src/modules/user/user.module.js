...
var UserModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [auth_module_1.AuthModule, follow_module_1.FollowModule, storage_module_1.StorageModule, prisma_module_1.PrismaModule],
            controllers: [user_controller_1.UserController],
            providers: [user_service_1.UserService, user_profile_service_1.UserProfileService],
