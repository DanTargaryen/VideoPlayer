export const USER_PROFILE_BEHAVIOR_WEIGHTS = {
  category: {
    like: 3,
    favorite: 5,
    comment: 4,
...
export const USER_PROFILE_ACTIVITY_THRESHOLDS = {
  high: 24,
  medium: 10,
} as const;

export const USER_PROFILE_WATCH_THRESHOLDS = {
  warmRatio: 0.3,
  deepRatio: 0.6,
  completeRatio: 0.9,
...
export const USER_PROFILE_WATCH_WEIGHTS = {
  category: {
    play: 0.5,
    warmRatio: 0.5,
    deepRatio: 1,
