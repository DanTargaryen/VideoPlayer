...
var RegisterDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _nickname_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
...
var LoginDto = function () {
    ...
    var _password_initializers = [];
    var _password_extraInitializers = [];
    var _adminSecret_decorators;
    var _adminSecret_initializers = [];
    var _adminSecret_extraInitializers = [];
    return _a = /** @class */ (function () {
            function LoginDto() {
                ...
                this.adminSecret = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _adminSecret_initializers, void 0));
                __runInitializers(this, _adminSecret_extraInitializers);
            }
            return LoginDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _account_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _password_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _adminSecret_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            ...
            __esDecorate(null, null, _password_decorators, { kind: "field", name: "password", static: false, private: false, access: { has: function (obj) { return "password" in obj; }, get: function (obj) { return obj.password; }, set: function (obj, value) { obj.password = value; } }, metadata: _metadata }, _password_initializers, _password_extraInitializers);
            __esDecorate(null, null, _adminSecret_decorators, { kind: "field", name: "adminSecret", static: false, private: false, access: { has: function (obj) { return "adminSecret" in obj; }, get: function (obj) { return obj.adminSecret; }, set: function (obj, value) { obj.adminSecret = value; } }, metadata: _metadata }, _adminSecret_initializers, _adminSecret_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a;
}();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.authService.register(dto)];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = api_response_dto_1.ok;
                            return [4 /*yield*/, this.authService.login(dto.account, dto.password, dto.adminSecret)];
                        case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent()])];
                    }
                });
            });
        };
        AuthController_1.prototype.me = function (authorization) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
