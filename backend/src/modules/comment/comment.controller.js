...
var CreateCommentDto = function () {
    ...
    var _rootId_decorators;
    var _rootId_initializers = [];
    var _rootId_extraInitializers = [];
    return _a = /** @class */ (function () {
            function CreateCommentDto() {
                this.content = __runInitializers(this, _content_initializers, void 0);
                this.parentId = (__runInitializers(this, _content_extraInitializers), __runInitializers(this, _parentId_initializers, void 0));
                this.rootId = (__runInitializers(this, _parentId_extraInitializers), __runInitializers(this, _rootId_initializers, void 0));
                __runInitializers(this, _rootId_extraInitializers);
            }
            return CreateCommentDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _content_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(1), (0, class_validator_1.MaxLength)(1000)];
            _parentId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsInt)()];
            _rootId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsInt)()];
            ...
            __esDecorate(null, null, _rootId_decorators, { kind: "field", name: "rootId", static: false, private: false, access: { has: function (obj) { return "rootId" in obj; }, get: function (obj) { return obj.rootId; }, set: function (obj, value) { obj.rootId = value; } }, metadata: _metadata }, _rootId_initializers, _rootId_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a;
}();
var CommentController = function () {
    var _classDecorators = [(0, common_1.Controller)('videos/:id/comments')];
    ...
    var CommentController = _classThis = /** @class */ (function () {
        function CommentController_1(authService, commentService) {
            this.authService = (__runInitializers(this, _instanceExtraInitializers), authService);
            this.commentService = commentService;
        }
        CommentController_1.prototype.getComments = function (id) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.commentService.listComments(id)];
                        case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent()])];
                    }
                });
            });
        };
        CommentController_1.prototype.createComment = function (authorization, id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            _a = api_response_dto_1.ok;
                            return [4 /*yield*/, this.commentService.createComment(id, user, dto)];
    ...
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _getComments_decorators = [(0, common_1.Get)()];
