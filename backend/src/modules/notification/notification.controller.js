...
var NotificationController = function () {
    ...
    var NotificationController = _classThis = /** @class */ (function () {
        function NotificationController_1(authService, notificationService) {
            this.authService = (__runInitializers(this, _instanceExtraInitializers), authService);
            this.notificationService = notificationService;
        }
        NotificationController_1.prototype.listNotifications = function (authorization) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.notificationService.listNotifications(user.id)];
                        case 2: return [2 /*return*/, _a.apply(void 0, [_b.sent()])];
                    }
                });
            });
        };
        NotificationController_1.prototype.unreadCount = function (authorization) {
            return __awaiter(this, void 0, void 0, function () {
                var user, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            _a = api_response_dto_1.ok;
                            return [4 /*yield*/, this.notificationService.getUnreadCount(user.id)];
                        case 2: return [2 /*return*/, _a.apply(void 0, [_b.sent()])];
                    }
                });
            });
        };
        NotificationController_1.prototype.readAll = function (authorization) {
            return __awaiter(this, void 0, void 0, function () {
                var user, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            _a = api_response_dto_1.ok;
                            return [4 /*yield*/, this.notificationService.markAllAsRead(user.id)];
                        case 2: return [2 /*return*/, _a.apply(void 0, [_b.sent()])];
                    }
                });
            });
    ...
    (function () {
        ...
        _listNotifications_decorators = [(0, common_1.Get)()];
        _unreadCount_decorators = [(0, common_1.Get)('unread-count')];
        _readAll_decorators = [(0, common_1.Post)('read-all')];
