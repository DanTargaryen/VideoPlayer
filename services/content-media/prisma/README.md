...
- `Video.reviewSubmissionRequestId` uniquely identifies the current/most recent creator submission and `submittedAt` records its first accepted transition; exact request replays remain valid after the video leaves `DRAFT`.
