...
| 2026-09-02 | DOC-02 云原生/性能报告与课程 PDF | 新增云原生实验和三端点性能正式报告；保留课程指定 5 份 PDF，同时保留仓库既有 7-PDF 生成/QA 包；区分历史实验快照与当前集成基线，并明确 DEL-01 真人证据仍待补 | 5 PDF / 212 页 pdfplumber + Poppler 全页 QA；独立 QA/checksum；delivery package 2/2；verifier 双跑幂等；CRLF-aware diff check | PASS；5 份课程提交件无空白页、越界字、裁切、重叠或不可读页；远端应用级检查等待 PR #75 最终 SHA |
