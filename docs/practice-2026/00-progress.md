...
- [ ] `MS-02..04` 提取其余三个业务微服务并独立构建、测试和部署。
  ...
  - 执行清单：`docs/practice-2026/12-second-stage-todo.md`；MS-00/MS-01 foundation 已完成；C 已在 `feature/MS-02-content-media` 提交 schema、只读 API、内部 contract、identity mock/fallback、`ffprobe` 与独立镜像骨架，真实 content DB/MinIO 和 Gateway 切流仍待后续修复/验证；D/E 继续各自 foundation。
